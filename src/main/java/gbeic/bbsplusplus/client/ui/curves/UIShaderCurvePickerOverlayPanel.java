...
public class UIShaderCurvePickerOverlayPanel extends UIOverlayPanel
{
    ...
    private static final String BBSTOOLS_MOD_ID = "bbstools";
    private static final String BBSTOOLS_SUN_PATH_ROTATION = "sun_path_rotation";
    private static final String BBSTOOLS_CENTER_DEPTH = "center_depth";
    ...
    private static TreeNode buildTree()
    {
        ...
        boolean hasBBSTools = BBSPlusPlusMod.isModLoaded(BBSTOOLS_MOD_ID);

        if (hasBBSTools && BBSSettings.shaderCurvesEnabled.get())
        {
            addBuiltIn(root, builtIn, SUN_PATH_ROTATION, BBSTOOLS_SUN_PATH_ROTATION);
        }

        if (hasBBSTools)
        {
            addBuiltIn(root, builtIn, CENTER_DEPTH, BBSTOOLS_CENTER_DEPTH);
        }
